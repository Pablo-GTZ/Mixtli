...
horizontal_line_y = image.shape[0] * 7// 8  # Middle of the image
horizontal_line_x1 = 0  # Start from the left edge
horizontal_line_x2 = image.shape[1]  # Extend to the right edge
...
cv2.imshow('Image with Detected Lines and Horizontal Line', image_with_lines)
